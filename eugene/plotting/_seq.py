...
def _plot_seq_logo(
    ...
    **kwargs
    ...
    if len(highlight) > 0:
        ...
        print(to_highlight)
        viz_sequence.plot_weights_given_ax(ax, imp_scores, subticks_frequency=10, highlight=to_highlight, height_padding_factor=1, **kwargs)
    else:
        viz_sequence.plot_weights_given_ax(ax, imp_scores, subticks_frequency=10, height_padding_factor=1, **kwargs)
    ax.spines['right'].set_visible(False)
    ax.spines['top'].set_visible(False)
...
def seq_track(
    ...
    **kwargs : dict
    ...
    _plot_seq_logo(ax[1], seq, imp_scores=imp_scores, highlight=highlight, threshold=threshold, **kwargs)
