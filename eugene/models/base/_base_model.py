...
from torchmetrics import R2Score, ExplainedVariance, Accuracy, AUROC, F1Score, Precision, Recall
...
class BaseModel(LightningModule):
    def __init__(self, input_len, output_dim, strand="ss", task="regression", aggr=None, loss_fxn="mse", hp_metric=None, **kwargs):
        super().__init__()
        ...
        self.hp_metric_name = hp_metric if hp_metric is not None else default_hp_metric_dict[self.task]
