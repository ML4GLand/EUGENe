...
class scBasset(nn.Module):
    def __init__(self, num_cells, num_batches=None, l1=0.0, l2=0.0):
        ...
        self.fc1 = regularizers.L2(nn.Linear(in_features=32, out_features=num_cells), weight_decay=l1)
        self.sigmoid = nn.Sigmoid()
        
        if num_batches is not None:
            self.fc2 = regularizers.L2(nn.Linear(in_features=32, out_features=num_batches), weight_decay=l2)
