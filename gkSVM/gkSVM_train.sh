...
echo -e gkmtrain $trainposseqs $trainnegseqs $modelname -v 2 -T 16 -l 11 -k 8 -d 3 -w 1.345 -m 8000.0
gkmtrain $trainposseqs $trainnegseqs $modelname -v 2 -T 16 -l 11 -k 8 -d 3 -w 1.345 -m 8000.0
echo -e "\n"
...
echo -e gkmpredict /cellar/users/aklie/projects/EUGENE/data/2021_OLS_Library/fasta/0.09-0.4_X-hold-out_fasta.fa $modelname".model.txt" $resultdir/"0.09-0.4_X-hold-out_fasta.fa.predict.txt"
gkmpredict /cellar/users/aklie/projects/EUGENE/data/2021_OLS_Library/fasta/0.09-0.4_X-hold-out_fasta.fa $modelname".model.txt" $resultdir/"0.09-0.4_X-hold-out_fasta.fa.predict.txt"